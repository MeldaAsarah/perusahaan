    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0-shadow rounded">
                <div class="card-body">
                    <a href="{{route('golongan.create')}}" class="btn btn-md btn-success mb-3">TAMBAH BLOG</a>
                ...
                <tbody>
                    @forelse($golongans as $golongan)
                     <tr>
                        ...
                        <td>{{ $golongan->gajipokok }}</td>
                        <td class="text-center">
                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"action="{{route('golongan.destroy', $golongan->id)}}" method="POST">
